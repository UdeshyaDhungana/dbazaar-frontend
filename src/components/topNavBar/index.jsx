...
import { getMyDetails, removeTokens } from "../../services/userService";
    ...
    >
      <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
        ...
        <HStack spacing={8} alignItems={"center"}>
          <Image boxSize="40px" objectFit="cover" src={logo} alt="DLogo" />
          <Link to="/">
            <Box>
              <Heading size="lg" color="brandBlue.100">
                DecentBazaar
              </Heading>
            </Box>
          </Link>
          ...
          {user && (
            <Menu>
              ...
              <MenuList zIndex={"dropdown"}>
                ...
                <MenuItem>
                  <Link to="/products/mine">My Products</Link>
                </MenuItem>
                <MenuItem>
                  <Link to="/products/my-transfers">My Transfers</Link>
                </MenuItem>
                <MenuDivider />
